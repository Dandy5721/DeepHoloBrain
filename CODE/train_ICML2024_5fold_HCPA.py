...
from dataset import RtFCDataset, FCSCDataset
...
parser.add_argument('--output_path', type=str, default='ICML2024_spd0')
...
if __name__ == '__main__':
    ...
    input_dir = '*/HCP-A-SC_FC/AAL_116/FC/'
    ...
    full_dataset = FCSCDataset(input_dir,slice=slice(num_sample))  
    ...
    for fold, (train_idx, test_idx) in enumerate(kf.split(full_dataset), start=1):
        ...
        optimizer = SGD(model.parameters(), lr=0.01, weight_decay=1e-5, momentum=0.9)
