...
from dataset import RtFCDataset, FCSCDataset, ADataset, OASISDataset
...
# parser.add_argument('--fc_path', default='/ram/USERS/bendan/ACMLab_DATA/HCP-A-SC_FC/AAL_116/FC_MOTOR_FACENAME/')
# parser.add_argument('--sc_path', default='/ram/USERS/bendan/ACMLab_DATA/HCP-A-SC_FC/ALL_SC/')
parser.add_argument('--output_path', type=str, default='ICML2024_OASIS_spd0')
...
if __name__ == '__main__':
    ...
    input_dir = '*/OASIS_BOLD_SC/OASIS_FC160/'
    sc_dir = '*/structure_CN_AD/'

    label_dir = '*/OASIS_BOLD_SC/OASIS_label.csv'
    output_dir_name = args.output_path
    num_sample = len(
                [path for path in os.listdir(input_dir) if not path.startswith('.')]
            )
    full_dataset = OASISDataset(input_dir,label_dir,sc_dir,slice=slice(num_sample))  
