...
from dataset import RtFCDataset, FCSCDataset, FC_SCDataset, HCPADataset_pre
...
parser.add_argument('--output_path', type=str, default='ICML2024_hcp_adni_pre_spd1')
...
if __name__ == '__main__':
    ...
    for window in windows:
        ...
        train_loader = DataLoader(
            train_dataset, batch_size=30, shuffle=True, num_workers=num_workers
        )
        ...
        def test(data_loader):
            ...
            return losses.avg, purities.avg, all_predictions, acc, recall, f1
        ...
        for epoch in range(start_epoch, start_epoch + total_epochs):
            ...
            test_loss, test_acc, labels, accs, recalls, f1s = test(test_loader)
